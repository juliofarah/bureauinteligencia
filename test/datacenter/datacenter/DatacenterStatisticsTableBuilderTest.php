...
class DatacenterStatisticsTableBuilderTest extends PHPUnit_Framework_TestCase{
    ...
    private function table(){
        $json = '{';
            ...
            $json .=    '"values":[{"value":"218,33"},{"value":"220,00"},{"value":"67,52"},{"value":"4.558,33"}]}';
            //$json .=    '"values":[{"value":150},{"value":220},{"value":285},{"value":"-"}]}';
            $json .= ',{"variety":"variety2","type":"type2","origin":"origin2","destiny":"destiny2",';
            $json .=    '"values":[{"value":"234,75"},{"value":"224,50"},{"value":"53,72"},{"value":"2.886,25"}]}';
            ...
            $json .=    '"values":[{"value":"135,33"},{"value","148,00"},{"value":"30,07"},{"value":"904,33"}]}';
            $json .= ']';
        $json .= '}';
        return $json;
    }
